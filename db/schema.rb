...
ActiveRecord::Schema.define(version: 20150208163744) do
  ...
  add_index "users", ["twitter_oauth_token", "twitter_oauth_secret"], name: "index_users_on_twitter_oauth_token_and_twitter_oauth_secret", using: :btree
